...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    private ?string $username = null; // Ajout de la propriété username
     ...
     */
    #[ORM\OneToMany(targetEntity: RoadTrip::class, mappedBy: 'user')]
    ...
    {
        return (string) $this->username; // Modifié pour utiliser le username comme identifiant
    }
